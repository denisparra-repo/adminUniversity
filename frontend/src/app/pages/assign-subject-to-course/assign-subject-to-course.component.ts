...
@Component({
  selector: 'app-assign-subject-to-course',
  standalone: true,
  ...
  templateUrl: './assign-subject-to-course.component.html',
  styleUrl: './assign-subject-to-course.component.scss'
})
export class AssignSubjectToCourseComponent implements OnInit {
  ...
  onSubmit() {
      if (this.assignForm.valid) {
        ...
        this.courseService.assignSubjectToCourse(formValue).subscribe( res => {
          this.spinnerVisible = false;
